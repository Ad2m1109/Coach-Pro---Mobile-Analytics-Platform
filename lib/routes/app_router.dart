...
GoRouter buildAppRouter(BuildContext context) {
  ...
  return GoRouter(
    ...
    redirect: (BuildContext context, GoRouterState state) {
      ...
      if (isAuthenticated && isAuthenticating) return '/${AppRouteConstants.strategieRouteName}';
    ...
    routes: <RouteBase>[
      ...
      ShellRoute(
        builder: (BuildContext context, GoRouterState state, Widget child) {
          if (kDebugMode) debugPrint('ShellRoute builder called');
        ...
        routes: <RouteBase>[
          GoRoute(
            ...
            builder: (BuildContext context, GoRouterState state) {
              if (kDebugMode) debugPrint('StrategieScreen route builder called');
          ...
          GoRoute(
            ...
            builder: (BuildContext context, GoRouterState state) {
              if (kDebugMode) debugPrint('MatchesScreen route builder called');
          ...
          GoRoute(
            ...
            builder: (BuildContext context, GoRouterState state) {
              if (kDebugMode) debugPrint('PlayersScreen route builder called');
          ...
          GoRoute(
            ...
            builder: (BuildContext context, GoRouterState state) {
              if (kDebugMode) debugPrint('AnalyzeScreen route builder called');
          ...
          GoRoute(
            ...
            builder: (BuildContext context, GoRouterState state) {
              if (kDebugMode) debugPrint('SettingsScreen route builder called');
