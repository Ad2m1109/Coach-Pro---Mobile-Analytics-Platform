...
MatchTeamStatistics _$MatchTeamStatisticsFromJson(
  ...
  transitionSpeedData: json['transition_speed_data'] as Map<String, dynamic>?,
  ...
  tacticalWeaknessData: json['tactical_weakness_data'] as Map<String, dynamic>?,
);
